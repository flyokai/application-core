...
- **Mark as `#[Unmanaged]`** if the column has features the phase-1 model can't represent (e.g. computed columns, generated columns, or anything you don't want this tool to touch)
